function varargout = modaldlgYesNo(varargin)
...
gui_State = struct('gui_Name',          mfilename, ...
                   ...
                   'gui_OpeningFcn',    @modaldlgYesNo_OpeningFcn, ...
                   'gui_OutputFcn',     @modaldlgYesNo_OutputFcn, ...
                   'gui_LayoutFcn',     [], ...
                   'gui_Callback',      []);
...
function modaldlgYesNo_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = modaldlgYesNo_OutputFcn(hObject, eventdata, handles)
