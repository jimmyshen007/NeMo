...
SVNEveTools = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/trunk'; %change into relative path
AtlasingDir = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/Atlasing';
SPMdir8 = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/spm8';
niitools = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/nifti_toolbox';
ODFtools = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/ODF_Qball';
SCBtrack = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/Tracking_Bayes';
mymfiles = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/mymfiles';

addpath('/Users/Jimmy/Documents/nemo/LoCoTool/Files/BCT');
addpath(SCBtrack)
addpath(mymfiles)
...
main_dir = '/Users/Jimmy/Documents/nemo/LoCoTool/Files/Tractograms/';
...
if strcmp(CalcSpace,'MNI') || strcmp(CalcSpace,'both')
    ...
    for i = 1:size(PatStr,1)
        ...
        OrigMat = load([FT_MNI filesep 'AllConnMatrices' num2str(atlassize) '_FT_MNI' filesep 'Matrix_TFC' num2str(atlassize) '_MNI_' patstr '.mat']);
...
for ii = 1:runl
    ...
    PR = load(strcat(PathsByRegion, [filesep 'PathsInROI_'], num2str(i),'.mat')); % To be replaced by nemo_read function
