function [All_LoCoMNI,All_LoCoT1] = LoCoCalc(DamageFileName,Coreg2MNI,CalcSpace,atlassize,StrSave,NumWorkers,dispMask)
...
if strcmp(CalcSpace,'MNI') || strcmp(CalcSpace,'both')
    ...
    for i = 1:size(PatStr,1)
        ...
        [hha,xxa] = hist(Affzon(find(Affzon)),1:1:atlassize);
        perc_Affect = hha./hh;
        All_PA = perc_Affect;
...
if strcmp(CalcSpace,'T1') || strcmp(CalcSpace,'both')
    ...
    for i = 1:size(PatStr,1)
        ...
        [hh,xx] = hist(Regions(find(Regions)),1:1:116);
        [hha,xxa] = hist(Affzon(find(Affzon)),1:1:116);
        perc_Affect = hha./hh;
        All_PA = perc_Affect;
