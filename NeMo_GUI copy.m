...
% Last Modified by GUIDE v2.5 13-May-2013 16:34:37
                ...
                if isValidFileType(damagefile)
                    ...
                    if (length(fileDim) == 3) 
                        if (fileDim(3) > 1)
                                ...
                                ChaCoCalc(damagefile, referenceFile, 'MNI', atlas, saveFolder, 1, 0, 0);
                                PlotChaCoResults([saveFolder filesep 'ChaCo' num2str(atlas) '_MNI'], outputtype);
                        else
