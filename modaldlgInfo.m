function varargout = modaldlgInfo(varargin)
...
% Last Modified by GUIDE v2.5 02-Jul-2012 13:55:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',          mfilename, ...
                   'gui_Singleton',     gui_Singleton, ...
                   'gui_OpeningFcn',    @modaldlgInfo_OpeningFcn, ...
                   'gui_OutputFcn',     @modaldlgInfo_OutputFcn, ...
                   'gui_LayoutFcn',     [], ...
                   'gui_Callback',      []);
...
function modaldlgInfo_OpeningFcn(hObject, eventdata, handles, varargin)
...
IconData=lightbulbIconData;
lightbulbIconMap(256,:)=get(handles.figure1,'color');
IconCMap=lightbulbIconMap;
...
function varargout = modaldlgInfo_OutputFcn(hObject, eventdata, handles)
