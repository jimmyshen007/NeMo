function [XYZ_mm, XYZ_src_vx] = nii_map_coords(XYZ_vx, trg, xfrm, src)
% map between coordinate systems/spaces
...
% http://www.cs.ucl.ac.uk/staff/g.ridgway/vbm/map_coords.m
