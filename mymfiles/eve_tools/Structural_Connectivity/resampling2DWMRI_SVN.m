function [newDiffFileNames, newGMMaskFileName, newWMMaskFileName, newContMaskFileName, newAtlasFileName] = resampling2DWMRI_SVN(DiffFileNames, GMMaskFileName, WMMaskFileName, ContMaskFileName, AtlasFileName,T1FileName,MRIOPT)
